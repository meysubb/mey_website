...
![_config.yml](SEC_BB/record_plots.png)
...
![_config.yml](SEC_BB/team_offense.png)
...
![_config.yml](SEC_BB/pit_dist.png)
...
![_config.yml](images/SEC_BB/rolling_plot.png)
...
![_config.yml](SEC_BB/plate_disc.png)
...
<iframe class="huge" src="SEC_BB/hc_hit.html"
    style="max-width = 100%"
...
<iframe class="huge" src="SEC_BB/hc_pit.html"
    style="max-width = 100%"
    sandbox="allow-same-origin allow-scripts"
    width="100%"
    height="600"
